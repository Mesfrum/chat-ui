	...
	>
		...
		<div class="w-full">
			...
			<form
				...
				class="relative flex w-full max-w-4xl flex-1 items-center rounded-md border bg-gray-100 focus-within:border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:focus-within:border-gray-500
